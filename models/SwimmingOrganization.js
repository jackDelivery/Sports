...
const SwimmingOrganizationSchema = new mongoose.Schema({
    name: {
        type: String,
        trim: true,
    },
...
SwimmingOrganizationSchema.methods.getJWTToken = function () {
...
const swimmingOrganizationModel = mongoose.model("SwimmingOrganization", SwimmingOrganizationSchema);

module.exports = { swimmingOrganizationModel }