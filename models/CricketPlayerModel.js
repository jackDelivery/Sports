...
CricketPlayerSchema.methods.getJWTToken = function () {
...
const cricketPlayerModel = mongoose.model("CRICKETPLAYER", CricketPlayerSchema);

module.exports = { cricketPlayerModel }